...
public class SphereChanger : MonoBehaviour {
	...
	Coroutine coFadeCamNextSphere;
	Coroutine coDelayTest;
    ...
    {
		coDelayTest = StartCoroutine(DelayTest());
        //Start the fading process
		//StartCoroutine(FadeCamera(nextSphere));
		coFadeCamNextSphere = StartCoroutine(FadeCamera(nextSphere));

    }


	public void StopChangeSphere(Transform nextSphere)
	{

		StopCoroutine(coDelayTest);
		StopCoroutine(coFadeCamNextSphere);
	}
